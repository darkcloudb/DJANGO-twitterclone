...
Help: Received help from Alex Mourtos on the follow functions % @syntax and notifications. Thanks to my brother Irvin for helping me with filtering out own tweets and follower's tweets.

Citation: https://www.dev2qa.com/how-to-fix-user-matching-query-does-not-exist-error-in-django-unit-test/ (helped me figure out the tweet counts)
https://stackoverflow.com/questions/60895151/django-search-device-list-missing-1-required-positional-argument-id (also helped me with tweet counts)
